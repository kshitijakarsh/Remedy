    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <nav className="fixed w-full bg-white/80 backdrop-blur-md shadow-sm z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <span className="text-3xl font-extrabold text-pharmacy-primary">Remedy</span>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-pharmacy-primary hover:bg-pharmacy-secondary text-white font-semibold py-3.5 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                Request Demo
              </button>
              <button className="bg-white text-pharmacy-primary font-semibold py-3.5 px-8 rounded-full border-2 border-pharmacy-primary hover:bg-pharmacy-primary hover:text-white transition-all duration-300">
                Learn More
              </button>
            </div>
          </div>
      ...
      <section id="benefits" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 space-y-8">
              <h2 className="text-4xl font-bold text-gray-900">Why Choose Remedy</h2>
              <p className="text-xl text-gray-600">
                Our system ensures accuracy, efficiency, and better service delivery, enabling pharmacies to focus on what matters most.
              </p>
      ...
      <section className="py-20 bg-gradient-to-r from-pharmacy-primary via-pharmacy-secondary to-pharmacy-primary bg-[length:200%_100%] animate-gradient">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto">
            Join hundreds of pharmacies already using Remedy to streamline operations and enhance customer service.
          </p>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 transition-all duration-300 hover:shadow-2xl hover:transform hover:scale-105">
      <div className="flex items-center mb-6">
        <div className="bg-pharmacy-light/50 p-4 rounded-xl">
          {icon}
        </div>
      </div>
